 ...
 * Generated at: 2026-09-05T08:58:22.721Z
 *
...
export interface PreferenceSchemas {
  default: {
    ...
    // target-key-definitions/complex/complex
    'feature.transcription.organization_model_id': string | null
    // target-key-definitions/complex/complex
    ...
    // target-key-definitions/complex/complex
    'shortcut.file_manager.copy': PreferenceTypes.PreferenceShortcutType
    // target-key-definitions/complex/complex
    'shortcut.file_manager.copy_path': PreferenceTypes.PreferenceShortcutType
    // target-key-definitions/complex/complex
    'shortcut.file_manager.cut': PreferenceTypes.PreferenceShortcutType
    // target-key-definitions/complex/complex
    'shortcut.file_manager.delete': PreferenceTypes.PreferenceShortcutType
    // target-key-definitions/complex/complex
    'shortcut.file_manager.new_file': PreferenceTypes.PreferenceShortcutType
    // target-key-definitions/complex/complex
    'shortcut.file_manager.new_folder': PreferenceTypes.PreferenceShortcutType
    // target-key-definitions/complex/complex
    'shortcut.file_manager.open': PreferenceTypes.PreferenceShortcutType
    // target-key-definitions/complex/complex
    'shortcut.file_manager.open_child_history': PreferenceTypes.PreferenceShortcutType
    // target-key-definitions/complex/complex
    'shortcut.file_manager.open_parent': PreferenceTypes.PreferenceShortcutType
    // target-key-definitions/complex/complex
    'shortcut.file_manager.open_terminal_here': PreferenceTypes.PreferenceShortcutType
    // target-key-definitions/complex/complex
    'shortcut.file_manager.paste': PreferenceTypes.PreferenceShortcutType
    // target-key-definitions/complex/complex
    'shortcut.file_manager.properties': PreferenceTypes.PreferenceShortcutType
    // target-key-definitions/complex/complex
    ...
    // target-key-definitions/complex/complex
    'shortcut.terminal.close_all': PreferenceTypes.PreferenceShortcutType
    // target-key-definitions/complex/complex
    'shortcut.terminal.close_current': PreferenceTypes.PreferenceShortcutType
    // target-key-definitions/complex/complex
    'shortcut.terminal.close_others': PreferenceTypes.PreferenceShortcutType
    // target-key-definitions/complex/complex
    'shortcut.terminal.new': PreferenceTypes.PreferenceShortcutType
    // target-key-definitions/complex/complex
    'shortcut.terminal.switch_next': PreferenceTypes.PreferenceShortcutType
    // target-key-definitions/complex/complex
    'shortcut.terminal.switch_previous': PreferenceTypes.PreferenceShortcutType
    // target-key-definitions/complex/complex
...
export const DefaultPreferences: PreferenceSchemas = {
  default: {
    ...
    'feature.transcription.organization_model_id': null,
    ...
    'shortcut.file_manager.copy': { binding: ['CommandOrControl', 'C'], enabled: true },
    'shortcut.file_manager.copy_path': { binding: ['CommandOrControl', 'Shift', 'C'], enabled: true },
    'shortcut.file_manager.cut': { binding: ['CommandOrControl', 'X'], enabled: true },
    'shortcut.file_manager.delete': { binding: ['Delete'], enabled: true },
    'shortcut.file_manager.new_file': { binding: ['CommandOrControl', 'N'], enabled: true },
    'shortcut.file_manager.new_folder': { binding: ['CommandOrControl', 'Shift', 'N'], enabled: true },
    'shortcut.file_manager.open': { binding: ['Enter'], enabled: true },
    'shortcut.file_manager.open_child_history': { binding: ['CommandOrControl', 'Down'], enabled: true },
    'shortcut.file_manager.open_parent': { binding: ['CommandOrControl', 'Up'], enabled: true },
    'shortcut.file_manager.open_terminal_here': { binding: ['CommandOrControl', 'Shift', 'T'], enabled: true },
    ...
    'shortcut.terminal.close_all': { binding: [], enabled: false },
    'shortcut.terminal.close_current': { binding: ['CommandOrControl', 'W'], enabled: true },
    'shortcut.terminal.close_others': { binding: ['CommandOrControl', 'Alt', 'W'], enabled: true },
    'shortcut.terminal.new': { binding: ['CommandOrControl', 'T'], enabled: true },
    'shortcut.terminal.switch_next': { binding: ['CommandOrControl', 'Right'], enabled: true },
    'shortcut.terminal.switch_previous': { binding: ['CommandOrControl', 'Left'], enabled: true },
