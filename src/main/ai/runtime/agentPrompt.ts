...
- When unsure whether an action is safe, **always refuse** and ask the user to clarify through the Magic Box UI directly.
...
/** Materialize Magic Box-owned prompt policy once; runtime adapters only map base/append into their SDK. */
