  ...
  return (
    <main className="flex h-full min-h-0 flex-1 flex-col bg-background">
      <div className="flex h-full min-h-0">
        <aside className="flex w-64 min-w-56 flex-col border-border border-r">
        ...
        <aside className="w-2/5 min-w-72 border-border border-l" data-testid="workspace-preview-pane">
